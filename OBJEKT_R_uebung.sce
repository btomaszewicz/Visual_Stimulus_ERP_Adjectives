...
trial
{
    ...
    stimulus_event
    {
        picture P_Show_Question_Mark;
			...
			port_code = 195;
			#target_button = 2,3;        #  PCL sets this
...
trial
{
   trial_duration = 3000;  # Show the comprehension trial for a maximum of 3 seconds.
   all_responses = false;
...
trial
{
   trial_duration = 6000;  # Show the comprehension trial for a maximum of 7 seconds. ------- CHECK!!!!
#   trial_type = specific_response;
...
int N_of_Trials = 7;                          # TEST Number of Experimental Trials per Session.
...
begin
    ...
    begin
        ...
        */
        ...
        #E_Picture_Context2.set_target_button(int(V_Expected_Response));
